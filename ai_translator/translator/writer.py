...
class Writer:
    ...
    def save_translated_book(self, book: Book, ouput_file_format: str):
        ...
        if ouput_file_format.lower() == "pdf":
            ...
            LOG.error(f"Unsupported file type: {ouput_file_format}")
            return ""

        LOG.info(f"Translation completed, file saved to: {output_file_path}")
    ...
    def _save_translated_book_pdf(self, book: Book, output_file_path: str = None):
        ...
        LOG.info(f"Starting export: {output_file_path}")

        # Register Chinese font
        font_path = "../fonts/simsun.ttc"  # Please replace this path with your font file path
                ...
                if content.status:
                    if content.content_type == ContentType.TEXT:
                        ...
                        table_style = TableStyle([
                            ...
                            ('FONTNAME', (0, 0), (-1, 0), 'SimSun'),  # Change header font to "SimSun"
                            ('FONTSIZE', (0, 0), (-1, 0), 14),
                            ('BOTTOMPADDING', (0, 0), (-1, 0), 12),
                            ('BACKGROUND', (0, 1), (-1, -1), colors.beige),
                            ('FONTNAME', (0, 1), (-1, -1), 'SimSun'),  # Change table content font to "SimSun"
